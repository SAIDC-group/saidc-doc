---
title: Introduction
description: TurboMesh is a Nuxt documentation template built with Nuxt Content and TurboMesh.
icon: lucide:info
navigation: false
---
...
**TurboMesh** is created as a free alternative documentation solution to [Docus](https://docus.dev/) and [Nuxt UI Pro Docs](https://docs-template.nuxt.dev/).
