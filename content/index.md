---
title: Introduction
description: SAIDC is a Nuxt documentation template built with Nuxt Content and SAIDC.
icon: lucide:info
navigation: false
---
...
**SAIDC** is created as a free alternative documentation solution to [Docus](https://docus.dev/) and [Nuxt UI Pro Docs](https://docs-template.nuxt.dev/).
